...
def mainwindow():
    ...
    def values():
        ...
        def deriv(y, t, readN, readbeta, readgamma):
            S, I, R = y
            dS = ((-readbeta * S * I) / readN)
            dI = ((readbeta * S * I) / readN) - (readgamma * I)
            dR = (readgamma * I)
            return dS, dI, dR
        
        # Initial conditions are S0, I0, R0
        # Integrate the SIR equations over the time grid, t.
        solve = odeint(deriv, (S0, readi0, readr0), t, args=(N, readbeta, readgamma))
        S, I, R = solve.T
